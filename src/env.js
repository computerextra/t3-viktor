...
export const env = createEnv({
  server: {
    ...
    INTREXX_DATABASE_HOST: z.string(),
    INTREXX_DATABASE_USER: z.string(),
    INTREXX_DATABASE_PASSWORD: z.string(),
    INTREXX_DATABASE_NAME: z.string(),
    PCVISIT_DATABASE_NAME: z.string(),
  ...
  runtimeEnv: {
    ...
    PCVISIT_DATABASE_NAME: process.env.PCVISIT_DATABASE_NAME,
    INTREXX_DATABASE_HOST: process.env.INTREXX_DATABASE_HOST,
    INTREXX_DATABASE_USER: process.env.INTREXX_DATABASE_USER,
    INTREXX_DATABASE_PASSWORD: process.env.INTREXX_DATABASE_PASSWORD,
    INTREXX_DATABASE_NAME: process.env.INTREXX_DATABASE_NAME,
